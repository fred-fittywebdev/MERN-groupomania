  ...
  return (
    <AppBar className={classes.appBar} position="static" color="inherit">
      <div className={classes.brandContainer}>
        <Typography component={Link} to="/" className={classes.heading} variant="h2" align="center">Groupomania</Typography>
        <img className={classes.image} src={groupomania} alt="Logo de l'entrprise" height="40" />
      </div>
